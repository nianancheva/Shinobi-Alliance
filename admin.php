...
<head>
    ...
    <script>
        function eventAdder(){
            viewShinobiLists();
            document.getElementById('addShinobiButton').addEventListener("click", function(e) {

                addShinobi(document.getElementById("addShinobiUsername").value, document.getElementById("addShinobiRank").value);
                
            });

        }

        function addShinobi(username, rank){

            var xmlhttp = new XMLHttpRequest();

            xmlhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    document.getElementById("addShinobiResult").innerHTML = this.responseText;
                }
            }

            xmlhttp.open("GET", "addShinobi.php?username="+username+"&rank="+rank, true);
            xmlhttp.send();
            viewShinobiLists();
        }

        function viewShinobiLists(){

            var xmlhttp = new XMLHttpRequest();

            xmlhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    document.getElementById("shinobisView").innerHTML = this.responseText;
                }
            }

            xmlhttp.open("GET", "shinobisView.php", true);
            xmlhttp.send();
...
<body class="bg-black-alt font-sans leading-normal tracking-normal" onload="eventAdder();">
    		...
    		<div class="w-full container mx-auto flex flex-wrap items-center mt-0 pt-3 pb-3 md:pb-0">
    			...
    			<div class="w-2/3 pl-2 md:pl-0">
    				<a class="text-gray-100 text-base xl:text-xl no-underline hover:no-underline font-bold"  href="#"> 
    					<i class="fas fa-moon text-blue-400 pr-3"></i> Shinobi Alliance Admin Portal
    				</a>
                </div>
		...
		<div class="w-full px-4 md:px-0 md:mt-8 mb-16 text-gray-800 leading-normal">
            ...
            <div class="flex flex-row flex-wrap flex-grow mt-2">
                ...
                <div class="w-full p-3">
                    ...
                    <!--Graph Card-->
                    <div class="bg-gray-900 border border-gray-800 rounded shadow mb-5">
                        
                        <div class="border-b border-gray-800 p-4">
                            <h5 class="font-bold uppercase text-white">Rank an unranked shinobi!</h5>
                        </div>
                        ...
                        <div class="p-5">
                            ...
                            <form class="w-full max-w-lg" method="POST">
                              ...
                              <div class="md:flex md:items-center mb-6">
                                ...
                                <div class="md:w-2/3">
                                  <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" type="text" placeholder="Enter Name" id="addShinobiUsername">
                                </div>
                                ...
                                <div class="md:flex md:items-center mb-6">
                                    ...
                                    <div class="md:w-2/3">
                                        <select class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="addShinobiRank">
                                ...
                                <div class="md:flex md:items-center">
                                    ...
                                    <div class="md:w-2/3">
                                      <button id="addShinobiButton" class="shadow bg-purple-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="button">
                                            Add Shinobi!
                                      </button>
                                    </div>
                                </div>
                    ...
                    <div class="bg-gray-900 border border-gray-800 rounded shadow">
                        ...
                        <div class="border-b border-gray-800 p-4">
                            <h5 class="font-bold uppercase text-white">All Shinobis</h5>
                        </div>
                        
                        <div class="p-5 sm:rounded-lg ">

                                <table class="w-full text-sm text-left text-gray-400 bg-gray-700 ">
